...
#                 logger.debug("Initializing new vector store")
#                 self.vector_store = FAISS.from_documents(chunks, self.embeddings)
#                 logger.info("Created new vector store")
#             else:
#                 # Add new documents to existing vector store
#                 logger.debug("Merging with existing vector store")
#                 new_vector_store = FAISS.from_documents(chunks, self.embeddings)
#                 self.vector_store.merge_from(new_vector_store)
#                 logger.info(f"Merged {len(chunks)} chunks into existing vector store")
...
#             print(f"DEBUG: Error occur in load_vector _ store{str(e)} ")
